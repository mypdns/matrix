...
| Type     | URL                                                                                       |
| -------- | ----------------------------------------------------------------------------------------- |
| Clearnet/Tor | cat: `https://karma.crimeflare.eu.org:1984/api/mypdns/cat/`<br>committer: `https://karma.crimeflare.eu.org:1984/api/mypdns/committer/`<br>issue: `https://karma.crimeflare.eu.org:1984/api/mypdns/issue/`                                        |
