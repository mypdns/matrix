...
[here](https://framagit.org/my-privacy-dns/matrix/-/tree/master/safesearch)
...
at https://framagit.org/my-privacy-dns/matrix
...
marked as spam`" to [issue](https://framagit.org/my-privacy-dns/support/-/issues/268)
and we will get your account back on track.

| Category              | Commit issue                                                                               |
| :-------------------- | :----------------------------------------------------------------------------------------- |
| Adult contents        | https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=NSFW_Porn        |
| Adult CDN             | https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Adult_CDN        |
| Strict Adult contents | https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=NSFW_Strict      |
| Strict Adult CDN      | https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Strict_Adult_CDN |
| Snuff & gore          | https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=NSFW_Snuff       |
| Common support        | https://framagit.org/my-privacy-dns/support/-/issues/new                                   |
...
You can easily install the Chrome or **Firefox** browser add-on developed
...
| rpz-ip                      | A lists is `.in-addr.arpa.` reverse styled IP Blacklist to be used for DNS RPZ [Response IP Address](https://framagit.org/my-privacy-dns/support/-/wikis/RPZ-record-types#the-response-ip-address-trigger-rpz-ip)                                    |
...
<!-- The Link section -->
[adult.mypdns.cloud]: https://framagit.org/my-privacy-dns/support/-/wikis/RPZ-List#adultmypdnscloud "RPZ zone adult.mypdns.cloud"
[akismet]: https://mypdns.org/help/integration/akismet.md
[contact]: https://framagit.org/my-privacy-dns/support/-/wikis/home#contact "Get in touch with My Privacy DNS"
[CONTRIBUTING]: https://framagit.org/my-privacy-dns/matrix/-/blob/master/CONTRIBUTING.md "How to contribute to My Privacy DNS"
[disqus.com]: https://framagit.org/my-privacy-dns/porn-records/-/issues/1415 "Disqus SpyWare"
[DNS_recursor]: https://framagit.org/my-privacy-dns/support/-/wikis/dns/DnsResolver "DNS Recursor"
[DNS_RPZ]: https://framagit.org/my-privacy-dns/support/-/wikis/rpz/ "DNS RPZ Firewall"
[DNS-hosts]: https://framagit.org/my-privacy-dns/support/-/wikis/DNS-Hosts#location-in-the-file-system "hosts files locations"
[DNS-resolver]: https://framagit.org/my-privacy-dns/support/-/wikis/Performance-Test-of-Hosts-File-vs.-Dns-recursors "DNS recursors and DNS resolver"
[DNS]: https://framagit.org/my-privacy-dns/support/-/wikis/dns/
[Domains-Only Syntax]: https://github.com/AdguardTeam/AdGuardHome/wiki/Hosts-Blocklists#domains-only-syntax
[FalsePositive]: https://framagit.org/my-privacy-dns/support/-/wikis/False-Positive "What is: False Positive"
[ICS-Bind9]: https://mypdns.org/rpz/dns-rpz-integration/-/tree/master/Bind_9
[IP_Addresses]: https://framagit.org/my-privacy-dns/support/-/wikis/RPZ-record-types#the-response-ip-address-trigger-rpz-ip
[matrix]: https://framagit.org/my-privacy-dns/matrix "My Privacy DNS is aiming to be the most intelligent DNS Firewall throughout using the modern DNS RPZ approach"
[mypdns]: https://mypdns.org/
[news]: https://framagit.org/my-privacy-dns/support/-/wikis/Categories/News
[NSFW]: https://mypdns.org/groups/my-privacy-dns/-/issues?scope=all&state=all&label_name[]=NSFW%3A%3APorn "Not Safe For Weaklings"
[pi-hole_combo]: https://framagit.org/my-privacy-dns/support/-/issues/253 "What lists to use in pi-hole"
...
[SpyWare]: https://framagit.org/my-privacy-dns/support/-/wikis/SpyWare "What is SpyWare"
[strict_readme.md]: https://framagit.org/my-privacy-dns/matrix/-/blob/master/source/strict_filters/README.md
[support]: https://framagit.org/my-privacy-dns/support/-/issues "Support Forum for all non blacklisting questions"
[TLD]: https://framagit.org/my-privacy-dns/support/-/wikis/TLD-Top-level-domain "What is a Top level domain"
...
[wiki_DNS_host]: https://framagit.org/my-privacy-dns/support/-/wikis/DNS-Hosts "DNS hostsfile wiki"
[wiki_rpz-nsdname]: https://framagit.org/my-privacy-dns/support/-/wikis/RPZ-record-types#the-nsdname-trigger-rpz-nsdname-anchor-nsdname "DNS RPZ rpz-nsdname record types"
