[![My Privacy DNS](https://img.shields.io/badge/View-Mirror-e24329.svg?logo=gitlab&style=plastic)](https://framagit.org/my-privacy-dns/matrix)
...
| ~Malicious / malware                   | [malicious](https://framagit.org/my-privacy-dns/support/-/wikis/malicious) domain-ip- urls hosting malicious software, scripts, code etc.                                                                                                                                                                                                                                                         |
...
| ~Phishing                              | See [phishing](https://framagit.org/my-privacy-dns/support/-/wikis/phishing)                                                                                                                                                                                                                                                                                                                      |
...
| Pornography (Adult 18+) (porno-sites)  | ~"NSFW::Gore" / ~"NSFW::Porn" / ~"NSFW::Snuff" / ~"NSFW::Strict" Sites about all kinds of sexual content ranging from bare bosoms to hardcore porn and sm. [Porn Records](https://framagit.org/my-privacy-dns/matrix/-/blob/master/source/porn_filters/README.md)                                                                                                                                 |
...
| ~Scamming                              | [scamming](https://framagit.org/my-privacy-dns/support/-/wikis/scamming)                                                                                                                                                                                                                                                                                                                          |
...
| ~Typo_Squatting                        | [typosquatting](https://framagit.org/my-privacy-dns/support/-/wikis/typosquatting)                                                                                                                                                                                                                                                                                                                |
...
| ~WhiteList                             | [whitelist](https://framagit.org/my-privacy-dns/support/-/wikis/whitelist)                                                                                                                                                                                                                                                                                                                        |
...
| :------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------- |
| [AdWare][AdWare]                                                                                                                                         | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=AdWare`              |
| Bait sites                                                                                                                                               |                                                                                                 |
| [Crypto Miners][CryptoMiners]                                                                                                                            | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=CryptoMiner`         |
| [DNS Server][DNS-Server]                                                                                                                                 | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=DNS%20Server`        |
| Drugs                                                                                                                                                    |                                                                                                 |
| [Gambling][Gambling]                                                                                                                                     | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Gambling`            |
| [IP Blocking][IP-Blocking]                                                                                                                               | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=IP%20Blocking`       |
| [Malicious/MalWare][MalWare]                                                                                                                             | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Malicious%20MalWare` |
| movies / streaming                                                                                                                                       |                                                                                                 |
| News                                                                                                                                                     |                                                                                                 |
| [Phishing][Phishing]                                                                                                                                     | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Phishing`            |
| [Pirated Domain][PiratedDomain]                                                                                                                          | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Pirated%20Domain`    |
| Politics                                                                                                                                                 |                                                                                                 |
| [Redirecting][Redirecting] (uri shortener)                                                                                                               | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Redirecting`         |
| Religion                                                                                                                                                 |                                                                                                 |
| [Removal][Removal] Read the F.A.Q. *BEFORE* you proceed!                                                                                                 | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Removal`             |
| [Scamming][Scamming] *Upcoming* (In development)                                                                                                         | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Scamming`            |
| [Spam][Spam]                                                                                                                                             | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Spam`                |
| [Spyware][Spyware]                                                                                                                                       | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Spyware`             |
| Suspected                                                                                                                                                |
| [Tracking][Tracking]                                                                                                                                     | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Tracking`            |
| [Typo Squatting][TypoSquatting]                                                                                                                          | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Typo%20Squatting`    |
| Weapons                                                                                                                                                  |                                                                                                 |
| [Whitelist][Whitelist]                                                                                                                                   | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Whitelist`           |
| [False Negatives/Removals][Removals]                                                                                                                     | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=False%20Positive`    |
|                                                                                                                                                          |                                                                                                 |
| <h2>Special Templates</h2>                                                                                                                               |                                                                                                 |
| [-aa][Bulk-commits]<br>  A fast bulk template modified constantly to match a specific case                                                               | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=-aa`                 |
| [getadmiral][]<br> A Template to ensuring the needed data while committing [getadmiral].com treats to make them connected and optimize the reaction data | `https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=getadmiral`          |
...
**A**: Yep sorry about that, it happens when you are trying to commit
	   ...
	   support ticket here: https://framagit.org/my-privacy-dns/support/-/issues/268
	   and we will get your account "Released".


[AdWare]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=AdWare "Issue template to commit adserver domains"
[Bulk-commits]: https://framagit.org/my-privacy-dns/support/-/wikis/Contributing#bulk-commits
[CryptoMiners]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=CryptoMiner "Issue template to commit Crypto miners"
[DNS-Server]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=DNS%20Server "Issue template to commit For blacklisting at the DNS level"
[EasyList]: https://github.com/easylist/easylist/
[Gambling]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Gambling "Issue template to commit Gambling site"
[getadmiral]: https://framagit.org/my-privacy-dns/matrix/-/issues/3023
[IP-Blocking]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=IP%20Blocking "Issue template to commit Blocking by IP addresses"
[MalWare]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Malicious%20MalWare "Issue template to commit Malicious and or Malware"
[mypdnsReport]: https://mypdns.org/infrastructure/mypdns-report
[Phishing]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Phishing "Issue template to commit Phishing"
[PiratedDomain]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Pirated%20Domain "Issue template to commit Outdated domain, pirated and hijacked by domains Jackal's"
[Redirecting]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Redirecting "Issue template to commit URL shortening and other redirecting only domain"
[Removal]: #faq "Read the F.A.Q. *BEFORE* you proceed!"
[Removals]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=False%20Positive "False Positive or removal of domains"
[Scamming]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Scamming "Issue template to commit Scamming sites"
[Spam]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Spam "Issue template to commit Spam records"
[Spyware]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Spyware "Issue template to commit Spyware domains"
[Tracking]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Tracking "Issue template to commit Tracking records"
[TypoSquatting]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Typo%20Squatting "Issue template to commit Typo Squatting"
[Whitelist]: https://framagit.org/my-privacy-dns/matrix/-/issues/new?issuable_template=Whitelist
[RPZ]: https://framagit.org/my-privacy-dns/support/-/wikis/RPZ "Response Policy Zone"
[hosts-list]: https://framagit.org/my-privacy-dns/hosts/-/tree/master/download "Hosts foratted blacklists"
